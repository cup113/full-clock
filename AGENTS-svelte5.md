...
<!-- Child.svelte -->
<script lang="ts">
  let { children, footer }: { children: import('svelte').Snippet, footer: import('svelte').Snippet<[string]> } = $props();
</script>
...
*Hint: Don't use `on:click`; use `onclick` now.*
